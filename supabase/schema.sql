...
create table if not exists public.subscriptions (
  ...
  tier text not null check (tier in ('free', 'test', 'starter', 'professional', 'premium', 'pro', 'enterprise', 'lifetime')),
  status text not null check (status in ('active', 'canceled', 'cancelled', 'expired', 'trialing')) default 'active',
